...
class AwsIamAddRoleToInstanceProfileV1
  ...
  def execute()
    ...
    puts "Role '#{@parameters['role_name']}' was added to instance profile '#{@parameters['instance_profile_name']}'." if @enable_debug_logging
