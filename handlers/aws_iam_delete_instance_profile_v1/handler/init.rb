...
class AwsIamDeleteInstanceProfileV1
  ...
  def execute()
    ...
    resp = @iam.delete_instance_profile(
      instance_profile_name: @parameters['instance_profile_name']
    )

    puts "Instance profile '#{@parameters['instance_profile_name']}' was deleted." if @enable_debug_logging
